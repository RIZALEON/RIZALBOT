...
enum CoinPathScout {
    ...
    static func ingestRemoteEnvelope(_ obj: [String: Any], fromPeer: String) -> String {
        // LAB SHOT remote — handle before coin-path merge
        let shotNote = LabShotCommand.handleRemoteEnvelope(obj, fromPeer: fromPeer)
        if !shotNote.isEmpty { return shotNote }
