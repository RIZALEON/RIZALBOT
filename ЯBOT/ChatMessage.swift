...
struct ChatMessage: Identifiable, Equatable, Codable {
    ...
    var lane: ChatLane
    /// Who spoke — stamped at creation, NEVER rewritten when seat renames later.
    /// Missing in old jsonl → nil (UI falls back by role: U / Я / system).
    ...
    enum CodingKeys: String, CodingKey {
        case id, role, text, createdAt, lane, speakerLabel
    }
