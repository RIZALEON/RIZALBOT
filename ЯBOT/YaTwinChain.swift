...
enum YaTwinChain {
    ...
    // Channel association supplied by Decider; not independently verified or published on-chain.
    static let channelName = "CHANNEL R"
    static let channelHandle = "@ЯВОТК"
    static let channelURL = "https://www.youtube.com/channel/UCv6jiq9mDApCVL7r6BWvMcg"
