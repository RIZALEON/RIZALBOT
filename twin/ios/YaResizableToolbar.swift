...
///   LEFT  = Bolte · Lab · Search   (icons ONLY — search field is NOT in this HStack)
///   CENTER = Home (ghost-heart) — NEVER translates when search opens
///   RIGHT = Vault · Online/Offline · Mind — NEVER pushed by left/search growth
...
struct YaResizableToolbar: View {
    ...
    var body: some View {
        GeometryReader { geo in
            ...
            // Left cluster width (3 icons + gaps + leading pad) — search overlays AFTER this.
            let leftClusterW = hPad + iconS * 3 + m.iconSpacing * 2
            ...
            ZStack(alignment: .center) {
                ...
                // LEFT magnet — Bolte · Lab · Search icons ONLY (no accessory in-flow)
                ...
                // RIGHT magnet — Vault · Mode · Mind (independent; search cannot shove)
                HStack(alignment: .center, spacing: m.iconSpacing) {
                    Spacer(minLength: 0)
